    ...
    <ul id="main-menu" class="">
        ...
        ?> ">
            <a href="#">
                ...
                <span><?php echo ('STRUCTURES'); ?></span>
            </a>
            <ul>
                <li class="<?php if ($page_name == 'class') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/classes">
                        <span><i class="entypo-dot"></i> <?php echo ('Gestion des Structures'); ?></span>
                    </a>
                </li>
        ...
        <li class="<?php if ($page_name == 'subject') echo 'opened active'; ?> ">
            <a href="#">
                ...
                <span><?php echo ('Projets et Stratégies'); ?></span>
            </a>
            <ul>
                <?php
        ...
        <li class="<?php if ($page_name == 'class_routine') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?admin/class_routine">
                ...
                <span><?php echo ('Activités des Structures'); ?></span>
            </a>
        </li>
        ...
        ?> ">
            <a href="#">
                ...
                <span><?php echo ('Section Potentiels Electeurs'); ?></span>
            </a>
            <ul>
                <!-- STUDENT ADMISSION -->
                 ...
                 <li class="<?php if ($page_name == 'acd_session') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/acd_session">
                        <span><i class="entypo-dot"></i> <?php echo ('Gestion des Sprints'); ?></span>
                    </a>
                </li>
                ...
                <li class="<?php if ($page_name == 'student_add') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/student_add">
                        <span><i class="entypo-dot"></i> <?php echo ('Admettre un Electeur'); ?></span>
                    </a>
                </li>
                ...
                <li class="<?php if ($page_name == 'student_bulk_add') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/student_bulk_add">
                        <span><i class="entypo-dot"></i> <?php echo ('Admettre les Justificatifs'); ?></span>
                    </a>
                </li>
                ...
                <li class="<?php if ($page_name == 'student_information') echo 'opened active'; ?> ">
                    <a href="#">
                        <span><i class="entypo-dot"></i> <?php echo ('Informations par lecteur'); ?></span>
                    </a>
                    <ul>
                        <?php
                        $classes = $this->db->get('class')->result_array();
                ...
                <li class="<?php if ($page_name == 'student_marksheet') echo 'opened active'; ?> ">
                    <a href="#">
                        <span><i class="entypo-dot"></i> <?php echo ('Notes des Electeurs'); ?></span>
                    </a>
                    <ul>
                        <?php
                        $classes = $this->db->get('class')->result_array();
        ...
        <li class="<?php if ($page_name == 'manage_attendance') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?admin/manage_attendance/<?php echo date("d/m/Y"); ?>">
                ...
                <span><?php echo ('Jours de Repos'); ?></span>
            </a>
        ...
        <!-- EXAMS -->
        <li class="<?php
        if ($page_name == 'enrolement' ||
                $page_name == 'evolution' ||
                $page_name == 'marks' ||
                    $page_name == 'notes enrôlement sms')
                        echo 'opened active';
        ?> ">
            <a href="#">

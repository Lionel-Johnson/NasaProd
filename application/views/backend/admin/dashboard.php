		...
		<div class="row">
            <div class="col-md-4">
                ...
                <div class="tile-stats tile-cyan">
                    ...
                    <h3><?php echo ('Total Justificatifs');?></h3>
            ...
            <div class="col-md-4">
                ...
                <div class="tile-stats tile-red">
                    ...
                    <h3><?php echo ('Potentiels Electeurs');?></h3>
            ...
            <div class="col-md-4">
                ...
                <div class="tile-stats tile-blue">
                    ...
                    <h3><?php echo ('Les Militants de Base');?></h3>
            ...
            <div class="col-md-4">
                ...
                <div class="tile-stats tile-black">
                    ...
                    <h3><?php echo ('Structures Actives');?></h3>
            ...
            <div class="col-md-4">
                ...
                <div class="tile-stats tile-pink">
                    ...
                    <h3><?php echo ('Boîte de réception');?></h3>

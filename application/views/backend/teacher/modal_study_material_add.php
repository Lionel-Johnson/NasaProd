        ...
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-heading">
                <div class="panel-title">
                    <h3><?php echo ('Ajouter un matériel électoral'); ?></h3>
                </div>
            </div>
            ...
            <div class="panel-body">
                ...
                <?php echo form_open(base_url().'index.php?teacher/study_material/create' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <div class="date-and-time">
                                <input type="text" name="timestamp" class="form-control datepicker" data-format="D, dd MM yyyy" placeholder="dater ici">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="field-ta" class="col-sm-3 control-label"><?php echo ('Fédértion'); ?></label>
